...
import { 
  ...
  Avatar, Divider, Chip, LinearProgress, useTheme, Table, 
  TableHead, TableRow, TableCell, TableBody 
} from '@mui/material';
import { 
  Download, FilterList, CalendarToday, TrendingUp, TrendingDown, 
            ...
            <Grid container spacing={3}>
                ...
                <Grid item xs={12} md={8}>
                    <Card sx={{ borderRadius: 3, p: 3, height: '100%', boxShadow: 'none', border: `1px solid ${theme.palette.divider}` }}>
                        ...
                        <Box height={350} width="100%" minWidth={400}>
                ...
                <Grid item xs={12} md={4}>
                    <Card sx={{ borderRadius: 3, p: 3, height: '100%', boxShadow: 'none', border: `1px solid ${theme.palette.divider}` }}>
                        ...
                        <Box display="flex" justifyContent="center" height={250} width="100%" minWidth={300}>
            ...
            <Grid container spacing={3}>
                <Grid item xs={12} md={6}>
                    <Card sx={{ borderRadius: 3, p: 3, height: '100%', boxShadow: 'none', border: `1px solid ${theme.palette.divider}` }}>
                        ...
                        <Box height={300} width="100%" minWidth={400}>
